...
const BotName = 'MR KING BOT';
const wa = '_BELUM TERSEDIA_';
const eror = 'Info fitur Error';
const ow = 'MR KING';
const nomorowner = '18313535216';
const ovo = '_BELUM TERSEDIA_';
const pulsa = '_BELUM TERSEDIA_';
const dana = '_BELUM TERSEDIA_';
const instagram = '_BELUM TERSEDIA_';
...
Halo Gan berikut adalah beberapa fitur yang ada pada bot yang bisa kamu gunakan !!!😇😇😇
📝 Note : Tidak Semua Menu Work 🤣
...
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Ocr*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Stalk (username ig)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Shortlink (link)*
*║*   
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.ssweb (link)*
*║*
*╚══‎ ꧁ ⌞≋≋≋≋≋⌝ ꧂══╝*
...
*║*              〘 *Other* 〙
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Sholat (Nama daerah)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Jadwaltv (nama channel)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Lirik*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Chord*
...
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Arti (Namamu)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Couple (Namamu & doi)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Getzodiak (Nama & tgl)
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Zodiak (Nama zodiak)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Mimpi (teks)*
*║*
*╚══‎ ꧁ ⌞≋≋≋≋≋⌝ ꧂══╝*
...
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Ping*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Seberapabucin*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Chatprank (teks1/teks2)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Alay (teks)*
*║*
*╚══‎ ꧁ ⌞≋≋≋≋≋⌝ ꧂══╝*
...
*║*              〘 *Edukasi* 〙
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Brainly (Pertanyaan)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Tl (Teks/kode bahasa)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Kodebahasa*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸*  *.Ngaji*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Alquran (nomor ayat)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Wiki*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Covid*
...
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Kbbi (Teks)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Tgl (Tanggal yang dicari)*
*║*
*╚══‎ ꧁ ⌞≋≋≋≋≋⌝ ꧂══╝*
...
*║*              〘 *Text [EROR]* 〙
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Bit8 (text/text)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Pubg (teks1/teks2)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Tahta (teks)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Coffee (teks)*
...
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Lol (teks)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Kata (quotes/author)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Logopornhub (teks1/teks2)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Lion (teks1/teks2)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Ninja (teks1/teks2)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Joker (teks1/teks2)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Glitch (teks1/teks2)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Wolf (teks1/teks2)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Snow (teks)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Old (teks)*
...
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Tik (link)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Joox (Judul lagu)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Yts (Judul lagu)*
*║*
*╚══‎ ꧁ ⌞≋≋≋≋≋⌝ ꧂══╝*
...
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Intro*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Setname (Teks)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Setdesc (Teks)*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Opengc*
*║*
*║*   *𖥨ํ∘̥⃟⸽⃟▸* *.Closegc*
